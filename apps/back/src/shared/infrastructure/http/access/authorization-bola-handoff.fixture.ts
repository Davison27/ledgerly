...
export const authorizationResourceParameterHandoffs: readonly AuthorizationResourceParameterHandoff[] = [
  ...
  { method: 'POST', path: '/equipment/:id/unarchive', parameters: ['id'], context: 'equipment', enforcement: 'Load the equipment by id before unarchiving it.' },
  ...
  { method: 'POST', path: '/projects/:id/unarchive', parameters: ['id'], context: 'projects', enforcement: 'Load the project by id before unarchiving it.' },
  ...
  { method: 'POST', path: '/staff/:id/unarchive', parameters: ['id'], context: 'staff', enforcement: 'Load the staff member by id before unarchiving it.' },
  { method: 'POST', path: '/suppliers/:id/unarchive', parameters: ['id'], context: 'suppliers', enforcement: 'Load the supplier by id before unarchiving it.' },
