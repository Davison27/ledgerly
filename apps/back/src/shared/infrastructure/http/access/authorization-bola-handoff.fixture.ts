...
export const authorizationResourceParameterHandoffs: readonly AuthorizationResourceParameterHandoff[] = [
  ...
  { method: 'DELETE', path: '/projects/:projectId/products/:productId', parameters: ['projectId', 'productId'], context: 'projects', enforcement: 'Verify the product association belongs to projectId before deletion.' },
  ...
  { method: 'GET', path: '/projects/:projectId/products', parameters: ['projectId'], context: 'projects', enforcement: 'Scope the product associations to projectId.' },
  ...
  { method: 'PATCH', path: '/schedule/events/:id', parameters: ['id'], context: 'schedule', enforcement: 'Load the schedule event by id before updating it.', additionalInputs: [{ location: 'body', key: 'projectId' }, { location: 'body', key: 'staffMemberIds[]' }, { location: 'body', key: 'products[].productId' }] },
  ...
  { method: 'POST', path: '/projects/:projectId/products', parameters: ['projectId'], context: 'projects', enforcement: 'Create the product association only under projectId.', additionalInputs: [{ location: 'body', key: 'productId' }] },
  { method: 'POST', path: '/staff/:staffMemberId/documents', parameters: ['staffMemberId'], context: 'staff', enforcement: 'Create the staff document only under staffMemberId and a known typeId.', additionalInputs: [{ location: 'body', key: 'typeId' }] },
