...
export const authorizationResourceParameterHandoffs: readonly AuthorizationResourceParameterHandoff[] = [
  ...
  { method: 'DELETE', path: '/clients/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the client by id before deletion.' },
  ...
  { method: 'DELETE', path: '/project-checklist-templates/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the checklist template by id before deletion.' },
  ...
  { method: 'DELETE', path: '/projects/:projectId/checklist/items/:itemId', parameters: ['projectId', 'itemId'], context: 'projects', enforcement: 'Verify the checklist item belongs to projectId before deletion.' },
  ...
  { method: 'DELETE', path: '/projects/:projectId/equipment/:equipmentId/lease-expenses/:expenseId', parameters: ['projectId', 'equipmentId', 'expenseId'], context: 'projects', enforcement: 'Verify the lease expense belongs to projectId and equipmentId before deletion.' },
  ...
  { method: 'GET', path: '/clients/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the client by id before returning it.' },
  ...
  { method: 'GET', path: '/project-checklist-templates/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the checklist template by id before returning it.' },
  { method: 'GET', path: '/projects/:projectId/checklist', parameters: ['projectId'], context: 'projects', enforcement: 'Scope the checklist read to projectId.' },
  ...
  { method: 'GET', path: '/release-notes/:version/acknowledgement', parameters: ['version'], context: 'release-notes', enforcement: 'Validate the release version and scope the acknowledgement lookup to the authenticated member.' },
  ...
  { method: 'PATCH', path: '/clients/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the client by id before updating it.' },
  ...
  { method: 'PATCH', path: '/projects/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the project by id before updating it.', additionalInputs: [{ location: 'body', key: 'clientId' }] },
  { method: 'PATCH', path: '/projects/:projectId/checklist/items/:itemId', parameters: ['projectId', 'itemId'], context: 'projects', enforcement: 'Verify the checklist item belongs to projectId before updating it.' },
  ...
  { method: 'POST', path: '/clients/:id/unarchive', parameters: ['id'], context: 'projects', enforcement: 'Load the client by id before unarchiving it.' },
  ...
  { method: 'POST', path: '/projects/:projectId/checklist/items', parameters: ['projectId'], context: 'projects', enforcement: 'Create the checklist item only under projectId.' },
  ...
  { method: 'PUT', path: '/project-checklist-templates/:id', parameters: ['id'], context: 'projects', enforcement: 'Load the checklist template by id before updating it.' },
  { method: 'POST', path: '/release-notes/:version/acknowledgement', parameters: ['version'], context: 'release-notes', enforcement: 'Validate the release version and take the acknowledgement owner only from the authenticated member.' },
  ...
  { method: 'GET', path: '/documents', parameters: [], context: 'documents', enforcement: 'Scope document filters by the reviewed query resource identifiers.', additionalInputs: [{ location: 'query', key: 'projectId' }, { location: 'query', key: 'clientId' }, { location: 'query', key: 'supplierId' }, { location: 'query', key: 'staffMemberId' }] },
  ...
  { method: 'POST', path: '/projects', parameters: [], context: 'projects', enforcement: 'Create the project only for a known client.', additionalInputs: [{ location: 'body', key: 'clientId' }] },
];
