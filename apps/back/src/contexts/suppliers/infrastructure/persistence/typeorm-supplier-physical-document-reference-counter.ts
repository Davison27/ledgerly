...
@Injectable()
export class TypeOrmSupplierPhysicalDocumentReferenceCounter implements PhysicalDocumentReferenceCounter {
  constructor(@InjectDataSource() private readonly dataSource: DataSource) {}

  async countPhysicalDocumentReferences(supplierId: string): Promise<number> {
