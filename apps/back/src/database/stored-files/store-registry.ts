import { StoredFileStore } from '../../shared/domain/stored-file-cipher.port';

export interface StoredFileStoreDescriptor {
...
export const STORED_FILE_STORES: readonly StoredFileStoreDescriptor[] = [
  {
    name: 'document',
    table: 'documents',
