...
let integrations: IntegrationDto[] = [
  {
    ...
    errorCode: null,
    settings: { calendar: 'Ledgerly · Agenda', syncDirection: 'Bidireccional', notifyOnError: true },
  },
  disconnected('google-drive', 'google'),
  {
    ...
    settings: { mailbox: 'facturas@ledgerly.es', label: 'facturas' },
  },
  disconnected('google-sheets', 'google'),
  disconnected('google-contacts', 'google'),
  disconnected('outlook-calendar', 'microsoft'),
  disconnected('onedrive', 'microsoft'),
  disconnected('excel-online', 'microsoft'),
  {
    key: 'slack',
    family: 'communication',
    status: 'connected',
    enabled: true,
    connectedAccount: 'Ledgerly',
    connectedAt: isoDaysAgo(15),
    lastSyncAt: isoHoursAgo(1),
    errorCode: null,
    settings: { channel: '#facturacion', events: 'Todos los avisos', notifyOnError: true },
  },
  disconnected('telegram', 'communication'),
  disconnected('discord', 'communication'),
  disconnected('outgoing-webhooks', 'open'),
  {
    ...
    settings: {
      ...
      syncDirection: 'Solo lectura (ICS)',
    },
  },
